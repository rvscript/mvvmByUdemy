...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="f77174f2-5b0d-465a-8813-089232cb8a38" name="Default Changelist" comment="" />
          ...
          <tree_state>
            <expand>
              <path>
                ...
                <item name="nycha-wm" type="f1a62948:ProjectNode" />
              </path>
            </expand>
            <select />
          </tree_state>
  ...
  <component name="FUSProjectUsageTrigger">
    <session id="816270207">
      ...
      <usages-collector id="statistics